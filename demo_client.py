...
client = JSONClient(("localhost",5500))
params = {"A":13,"B":9}
for a in range(5):
    params["A"] = a
    print client.call("SourceControl.Multiply", params)

params = {"Nchan":5, "SampleRate":1e4, "Min":1900, "Max":2100}
print client.call("SourceControl.ConfigureTriangleSource", params)
params = {"Nchan":5, "SampleRate":1e4, "Pedestal":5000, "Amplitude":20000, "Nsamp":1000}
print client.call("SourceControl.ConfigureSimPulseSource", params)
params = "SimPulseSource"
print client.call("SourceControl.Start", params)
time.sleep(10)
print client.call("SourceControl.Stop", "dummy")
